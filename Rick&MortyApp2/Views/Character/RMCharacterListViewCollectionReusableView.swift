//
//  RMCharacterListViewCollectionReusableView.swift
//  Rick&MortyApp2
//
...
final class RMCharacterListViewCollectionReusableView: UICollectionReusableView {
    
    
    static let identifier = "RMCharacterListViewCollectionReusableView"
