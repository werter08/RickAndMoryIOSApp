...
class RMCharacterInfoViewCell: UICollectionViewCell {
    static let Identifier = "RMCharacterInfoViewCell"
    ...
    public func Configure(viewMOdel: RMCharacterInfoViewCellViewModel){
        titleLabel.text = viewMOdel.toShowTitle
        titleLabel.textColor = viewMOdel.toShowColor
        iconImage.image = viewMOdel.toShowImage
